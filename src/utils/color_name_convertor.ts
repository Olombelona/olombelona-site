...
const impl_hex_to_name = Object.fromEntries(Object.entries(dic_name_to_hex).map(([k, v]) => [v, k]))
...
if(color_hex !== undefined) return impl_hex_to_name[color_hex.toLowerCase()];
}